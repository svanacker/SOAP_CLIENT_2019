 ...
 * 
 */
@WebServiceClient(name = "HelloWorld", targetNamespace = "http://webservices.j2ee.douai.mines.org/", wsdlLocation = "file:/C:/dev/git/mines/2019/helloWorld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLD_QNAME = new QName("http://webservices.j2ee.douai.mines.org/", "HelloWorld");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/dev/git/mines/2019/helloWorld.wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://webservices.j2ee.douai.mines.org/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.j2ee.douai.mines.org/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
